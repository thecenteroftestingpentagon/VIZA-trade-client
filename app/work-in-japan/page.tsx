  ...
  return (
    <div className="min-h-screen pt-20 relative">
      ...
      <div 
        ...
        style={{
          backgroundImage: "url('/country/Japan.jpeg')",
      ...
      <div className="container mx-auto px-4 py-8 relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-300 max-w-4xl mx-auto">
            Japan offers unique opportunities in technology, automotive, manufacturing, and robotics. With its rich culture, advanced technology, and strong work ethic, it's an attractive destination for skilled professionals seeking career growth.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          <Card className="bg-white/5 backdrop-blur-sm border-green-400/20">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-gray-300 text-sm">¥3,000,000 - ¥10,000,000+</p>
            </CardContent>
          </Card>
          <Card className="bg-white/5 backdrop-blur-sm border-green-400/20">
            <CardContent className="p-6 text-center">
          ...
          <Card className="bg-white/5 backdrop-blur-sm border-green-400/20">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-gray-300 text-sm">Japanese (English in tech)</p>
            </CardContent>
          </Card>
        </div>
          ...
          <Card className="bg-white/5 backdrop-blur-sm border-green-400/20">
            ...
            <CardContent>
              <div className="space-y-4">
                {[
                  { type: "Engineer/Specialist", description: "For technical professionals", duration: "1-5 years" },
                  { type: "Skilled Labor", description: "For specific skilled workers", duration: "1-5 years" },
                  { type: "Intra-company Transfer", description: "For company transfers", duration: "1-5 years" },
                  { type: "Highly Skilled Professional", description: "Points-based system", duration: "1-5 years" }
                ].map((visa, index) => (
        ...
        <Card className="bg-white/5 backdrop-blur-sm border-green-400/20 mt-8">
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {[
                { name: "Tokyo", description: "Capital and business center" },
                { name: "Osaka", description: "Commercial and industrial hub" },
                { name: "Yokohama", description: "International business center" },
                { name: "Nagoya", description: "Automotive industry center" },
                { name: "Kyoto", description: "Cultural center with tech companies" }
              ].map((city, index) => (
        ...
        <Card className="bg-gradient-to-r from-green-400/10 to-blue-400/10 backdrop-blur-sm border-green-400/20 mt-8">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-gray-300 mb-6">
              Get personalized guidance for your Japan work visa application. 
              Our experts will help you navigate the process smoothly.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button 
                className="bg-green-600 hover:bg-green-700 text-white px-8 py-3"
                onClick={() => window.open('https://wa.me/8160050554?text=Hi, I want to know more about working in Japan', '_blank')}
              >
