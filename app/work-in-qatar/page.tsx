    ...
    <>
      <div className="min-h-screen pt-20 relative">
        ...
        <div 
          ...
          style={{
            backgroundImage: "url('/country/Qatar.jpg')",
        ...
        <div className="container mx-auto px-4 py-8 relative z-10">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-300 max-w-4xl mx-auto">
              Qatar offers excellent opportunities in oil & gas, construction, finance, and hospitality sectors. With rapid development and infrastructure projects, it's a growing destination for skilled professionals.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            <Card className="bg-white/5 backdrop-blur-sm border-green-400/20">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-gray-300 text-sm">QAR 10,000 - 40,000+</p>
              </CardContent>
            </Card>
            <Card className="bg-white/5 backdrop-blur-sm border-green-400/20">
              <CardContent className="p-6 text-center">
            ...
            <Card className="bg-white/5 backdrop-blur-sm border-green-400/20">
              ...
              <CardContent>
                <div className="space-y-4">
                  {[
                    { type: "Work Visa", description: "Sponsored by Qatar employer", duration: "2-3 years" },
                    { type: "Business Visa", description: "For business activities", duration: "3-6 months" },
                    { type: "Investor Visa", description: "For investors and entrepreneurs", duration: "5 years" },
                    { type: "Family Visa", description: "For dependents", duration: "2-3 years" }
                  ].map((visa, index) => (
          ...
          <Card className="bg-white/5 backdrop-blur-sm border-green-400/20 mt-8">
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {[
                  { name: "Doha", description: "Capital and business center" },
                  { name: "Al Rayyan", description: "Industrial and residential hub" },
                  { name: "Al Wakrah", description: "Coastal city with port facilities" },
                  { name: "Lusail", description: "New planned city with modern infrastructure" },
                  { name: "Al Khor", description: "Industrial city with petrochemical facilities" }
                ].map((city, index) => (
          ...
          <Card className="bg-gradient-to-r from-green-400/10 to-blue-400/10 backdrop-blur-sm border-green-400/20 mt-8">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-gray-300 mb-6">
                Get personalized guidance for your Qatar work visa application. 
                Our experts will help you navigate the process smoothly.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button 
                  className="bg-green-600 hover:bg-green-700 text-white px-8 py-3"
                  onClick={() => window.open('https://wa.me/8160050554?text=Hi, I want to know more about working in Qatar', '_blank')}
                >
