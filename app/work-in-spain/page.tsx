...
export default function WorkInSpainPage() {
  return (
    <div className="min-h-screen pt-20 relative">
      ...
      <div 
        ...
        style={{
          backgroundImage: "url('/country/Spain.jpeg')",
      ...
      <div className="container mx-auto px-4 py-8 relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-300 max-w-4xl mx-auto">
            Spain offers a perfect blend of work-life balance, Mediterranean lifestyle, and growing opportunities in technology, renewable energy, and tourism. Enjoy excellent weather, rich culture, and a welcoming environment for international professionals.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          <Card className="bg-white/5 backdrop-blur-sm border-green-400/20">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-gray-300 text-sm">€20,000 - €70,000+</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white/5 backdrop-blur-sm border-green-400/20">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-gray-300 text-sm">€1,000 - €2,000/month</p>
            </CardContent>
          </Card>
            ...
            <Card className="bg-white/5 backdrop-blur-sm border-green-400/20">
              ...
              <CardContent>
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-white">Work Visa (General)</span>
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-white">Digital Nomad Visa</span>
              ...
              <CardContent>
                <div className="grid grid-cols-2 gap-4">
                  <div className="text-center p-4 bg-white/5 rounded-lg">
                    ...
                    <h4 className="text-white font-semibold">Madrid</h4>
                    <p className="text-gray-400 text-sm">Capital & Business</p>
                  </div>
                  <div className="text-center p-4 bg-white/5 rounded-lg">
                    <div className="text-2xl mb-2">🏖️</div>
                    <h4 className="text-white font-semibold">Barcelona</h4>
                    <p className="text-gray-400 text-sm">Tech & Tourism</p>
                  </div>
                  <div className="text-center p-4 bg-white/5 rounded-lg">
                    <div className="text-2xl mb-2">🏰</div>
                    <h4 className="text-white font-semibold">Valencia</h4>
                    <p className="text-gray-400 text-sm">Port & Industry</p>
                  </div>
                  <div className="text-center p-4 bg-white/5 rounded-lg">
                    <div className="text-2xl mb-2">🌊</div>
                    <h4 className="text-white font-semibold">Bilbao</h4>
            ...
            <CardContent className="p-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button 
                  ...
                  onClick={() => window.open('https://wa.me/8160050554?text=I%20am%20interested%20in%20working%20in%20Spain', '_blank')}
                >
