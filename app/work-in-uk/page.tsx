...
export default function WorkInUKPage() {
  return (
    <div className="min-h-screen pt-20 relative">
      ...
      <div 
        ...
        style={{
          backgroundImage: "url('/country/uk.jpg')",
      ...
      <div className="container mx-auto px-4 py-8 relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-300 max-w-4xl mx-auto">
            The UK offers diverse opportunities in finance, technology, healthcare, and creative industries. With its rich history and global connections, it's an attractive destination for skilled professionals.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          ...
          <Card className="bg-white/5 backdrop-blur-sm border-green-400/20">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-gray-300 text-sm">3-8 weeks</p>
            </CardContent>
          </Card>
          <Card className="bg-white/5 backdrop-blur-sm border-green-400/20">
            <CardContent className="p-6 text-center">
        ...
        <Card className="bg-gradient-to-r from-green-400/10 to-blue-400/10 backdrop-blur-sm border-green-400/20 mt-8">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-gray-300 mb-6">
              Get personalized guidance for your UK work visa application. 
              Our experts will help you navigate the process smoothly.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button 
                className="bg-green-600 hover:bg-green-700 text-white px-8 py-3"
                onClick={() => window.open('https://wa.me/8160050554?text=Hi, I want to know more about working in UK', '_blank')}
              >
